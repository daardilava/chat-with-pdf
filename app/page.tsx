...
const features = [
  ...
  {
    name: "Chat Memorisationr",
    description: "Our intelligent chatbot remember previous intereactions, providing a seamless and personalized experience.",
    icon: BrainCogIcon,
  },
  {
  ...
  {
    name: "Cloud Backup",
    description: "Rest assured knowing your documents are safely backed up con the cloud, protected from loss or damage.",
    icon: ServerCogIcon,
  },
  {
    name: "Responsive Across Devices",
    description: "Access and chat with your PDFs seamlessly on any device, wheter is your desktop, tablet or smartphone.",
          ...
          <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              ...
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                Transform You PDFs Into Interactive Conversations
              </p>
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                <span className="text-indigo-600"> Chat with PDF</span>{" "}turns statics documents into{" "}
            ...
            <div className="relative overflow-hidden pt-16">
              <div className="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div aria-hidden="true" className="relative">
                  <div className="absolute bottom-0 -insent-x-32 bg-gradient-to-t from-white/95 pt-[5%]" />
                </div>
              </div>
            </div>
              ...
              <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2
                          lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gapy16">
